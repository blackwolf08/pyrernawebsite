...
<script>
	...
	<div class="container-fluid">
	    ...
	    <div class="row">
			<div class="col-sm-2 leftpart">
				<div>
					<ul class="pad0">
						...
						<ul>
							<li class="selected" ><i class="fas fa-tag"></i><a style="color:black;" href="tags.php">Tags</a></li>
			...
			<div class="col-sm-10">
			    <h2>Ask Question :</h2>
			    <!--<div id="editor" style="padding-bottom:100%;">function sunny(items) {
                    var x = "All this is syntax highlighted";
                    return x;
                }</div>-->
                <form method="POST" action="askedQuestion.php">
                     <div class="form-group">
                    <input type="text" name="title" placeholder="Whats the title?" style="width:100%;"/>
                    </div>
                    <div class="form-group">
                    <input type="textarea" name="question" placeholder="Write your question here!" style="width:100%;padding-bottom:50%;"/>
                    </div>
                    <div class="form-group">
                    <input type="number" name="votes" placeholder="Votes(beta)"/>
                    </div>
                    <div class="form-group">
                    <input type="number" name="views" placeholder="Views(beta)"/>
                    </div>
                    <div class="form-group">
                    <input type="number" name="answers" placeholder="Answers(beta)"/>
                    </div>
